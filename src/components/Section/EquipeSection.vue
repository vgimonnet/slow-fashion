<template>
  <section id="equipe">
    <div class="half content">
      <h2>
        Notre équipe est avec vous pour faire
        <br>
        <i class="color-blue">évoluer</i> le <i>slow fashion français</i>
      </h2>
...
<style lang="scss">
  @import '../../assets/styles/components/sections/equipe.section.scss';
</style>